        ...
        {selectedConversation.bookingRequest && (
          <div className="card bg-base-100 border border-base-300">
            <div className="card-body p-4">
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`badge badge-sm ${
                    selectedConversation.bookingRequest.status === "PENDING" ||
                    selectedConversation.bookingRequest.status === "VIEWED"
                      ? "badge-warning"
              ...
              <div className="flex flex-wrap gap-4 text-sm text-base-content/70 mt-2">
                {selectedConversation.bookingRequest.duration && (
                  <span className="flex items-center gap-1">
                    ...
                    {selectedConversation.bookingRequest.duration} min
                  </span>
                )}
              ...
              {!isArtist &&
                ["PENDING", "VIEWED", "DECLINED"].includes(
                  selectedConversation.bookingRequest.status,
                ) && (
                  <Link
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-base-content/70 mt-1">
          Communiquez avec {isArtist ? "les venues" : "les artistes"} pour vos
          événements
        </p>
      </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2 mb-1">
                          <div className="flex-1 min-w-0">
                            <h3
                              className={`font-semibold text-lg truncate ${hasUnread ? "text-primary" : ""}`}
                            >
                        ...
                        {lastMessage && (
                          <p
                            className={`text-sm mb-2 line-clamp-1 ${hasUnread ? "font-medium text-base-content" : "text-base-content/60"}`}
                          >
