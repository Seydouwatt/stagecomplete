          ...
          <div className="container mx-auto px-4 h-16 flex items-center justify-between">
            ...
            >
              ...
              <span className="text-primary">
                <span className="text-secondary">Stage</span>Complete
              </span>
              <span>🎪</span>
            </Link>
            <div className="flex items-center gap-3">
              <Link
                to="/login"
                className="px-5 py-2 rounded-lg  bg-white text-purple-900 font-medium border border-white/30 hover:bg-white/10 transition-all duration-200"
              >
                Connexion
              </Link>
              <Link
                to="/register"
                className="px-5 py-2 rounded-lg bg-white text-purple-900 font-medium hover:bg-gray-100 transition-all duration-200"
              >
                Inscription
              </Link>
            </div>
          ...
          <div className="relative container mx-auto px-4 py-20">
            <div className="text-center max-w-5xl mx-auto">
              <motion.div
                ...
                className="text-2xl flex items-center gap-2 justify-center mb-4"
              >
              ...
              >
                ...
                <span className="text-sm font-medium">
                  La plateforme de découverte d'artistes
                </span>
              </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    "Renseignez vos informations artistiques, ajoutez vos photos et décrivez votre univers musical",
                  icon: UserGroupIcon,
                ...
                },
                {
                  ...
                  description:
                    "Obtenez une URL personnalisée et partagez votre profil sur les réseaux sociaux",
                  icon: GlobeAltIcon,
                ...
                },
                {
                  ...
                  description:
                    "Apparaissez dans les recherches publiques et connectez-vous avec de nouveaux fans",
                  icon: SparklesIcon,
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p>
            Une erreur s'est produite lors du chargement de la page d'accueil.
          </p>
        </div>
      </div>
    );
